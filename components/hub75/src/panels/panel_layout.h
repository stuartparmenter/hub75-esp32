...
class PanelLayoutRemap {
 public:
  ...
  static HUB75_CONST HUB75_IRAM constexpr Coords remap(Coords c, PanelLayout layout, uint16_t panel_w, uint16_t panel_h,
    ...
    switch (layout) {
      case PanelLayout::TOP_LEFT_DOWN: {
      ...
      case PanelLayout::TOP_RIGHT_DOWN: {
      ...
      case PanelLayout::BOTTOM_LEFT_UP: {
      ...
      case PanelLayout::BOTTOM_RIGHT_UP: {
      ...
      case PanelLayout::TOP_LEFT_DOWN_ZIGZAG: {
      ...
      case PanelLayout::TOP_RIGHT_DOWN_ZIGZAG: {
      ...
      case PanelLayout::BOTTOM_LEFT_UP_ZIGZAG: {
      ...
      case PanelLayout::BOTTOM_RIGHT_UP_ZIGZAG: {
...
consteval bool test_horizontal_identity() {
  ...
  constexpr Coords output = PanelLayoutRemap::remap(input, PanelLayout::HORIZONTAL, 64, 32, 1, 1);
...
consteval bool test_top_left_down_2x2() {
  ...
  constexpr Coords out_tl = PanelLayoutRemap::remap({0, 0}, PanelLayout::TOP_LEFT_DOWN, panel_w, panel_h, rows, cols);
  // {127,0} row=0 (even): x=255-127-0=128, y=31-0=31
  constexpr Coords out_tr = PanelLayoutRemap::remap({127, 0}, PanelLayout::TOP_LEFT_DOWN, panel_w, panel_h, rows, cols);
  // {0,63} row=1 (odd): x=0+0=0, y=31
  constexpr Coords out_bl = PanelLayoutRemap::remap({0, 63}, PanelLayout::TOP_LEFT_DOWN, panel_w, panel_h, rows, cols);
  // {127,63} row=1 (odd): x=0+127=127, y=31
  constexpr Coords out_br =
      PanelLayoutRemap::remap({127, 63}, PanelLayout::TOP_LEFT_DOWN, panel_w, panel_h, rows, cols);
...
consteval bool test_top_right_down_2x2() {
  ...
  constexpr Coords out_tl = PanelLayoutRemap::remap({0, 0}, PanelLayout::TOP_RIGHT_DOWN, panel_w, panel_h, rows, cols);
  // {127,0} row=0 (even): x=128+127=255, y=0
  constexpr Coords out_tr =
      PanelLayoutRemap::remap({127, 0}, PanelLayout::TOP_RIGHT_DOWN, panel_w, panel_h, rows, cols);
  // {0,63} row=1 (odd): x=255-0-128=127, y=31-31=0
  constexpr Coords out_bl = PanelLayoutRemap::remap({0, 63}, PanelLayout::TOP_RIGHT_DOWN, panel_w, panel_h, rows, cols);
  // {127,63} row=1 (odd): x=255-127-128=0, y=31-31=0
  constexpr Coords out_br =
      PanelLayoutRemap::remap({127, 63}, PanelLayout::TOP_RIGHT_DOWN, panel_w, panel_h, rows, cols);
...
consteval bool test_bottom_left_up_2x2() {
  ...
  constexpr Coords out_tl = PanelLayoutRemap::remap({0, 0}, PanelLayout::BOTTOM_LEFT_UP, panel_w, panel_h, rows, cols);
  // {127,0} row=0, inv_row=1 (odd): x=0+127=127, y=0
  constexpr Coords out_tr =
      PanelLayoutRemap::remap({127, 0}, PanelLayout::BOTTOM_LEFT_UP, panel_w, panel_h, rows, cols);
  // {0,63} row=1, inv_row=0 (even): x=255-0-0=255, y=31-31=0
  constexpr Coords out_bl = PanelLayoutRemap::remap({0, 63}, PanelLayout::BOTTOM_LEFT_UP, panel_w, panel_h, rows, cols);
  // {127,63} row=1, inv_row=0 (even): x=255-0-127=128, y=31-31=0
  constexpr Coords out_br =
      PanelLayoutRemap::remap({127, 63}, PanelLayout::BOTTOM_LEFT_UP, panel_w, panel_h, rows, cols);
...
consteval bool test_bottom_right_up_2x2() {
  ...
  constexpr Coords out_tl = PanelLayoutRemap::remap({0, 0}, PanelLayout::BOTTOM_RIGHT_UP, panel_w, panel_h, rows, cols);
  // {127,0} row=0, inv_row=1 (odd): x=255-128-127=0, y=31-0=31
  constexpr Coords out_tr =
      PanelLayoutRemap::remap({127, 0}, PanelLayout::BOTTOM_RIGHT_UP, panel_w, panel_h, rows, cols);
  // {0,63} row=1, inv_row=0 (even): x=128+0=128, y=31
  constexpr Coords out_bl =
      PanelLayoutRemap::remap({0, 63}, PanelLayout::BOTTOM_RIGHT_UP, panel_w, panel_h, rows, cols);
  // {127,63} row=1, inv_row=0 (even): x=128+127=255, y=31
  constexpr Coords out_br =
      PanelLayoutRemap::remap({127, 63}, PanelLayout::BOTTOM_RIGHT_UP, panel_w, panel_h, rows, cols);
...
consteval bool test_top_left_down_zigzag_2x2() {
  ...
  constexpr Coords out_tl =
      PanelLayoutRemap::remap({0, 0}, PanelLayout::TOP_LEFT_DOWN_ZIGZAG, panel_w, panel_h, rows, cols);
  // {127,0} row=0: x=128+127=255, y=0
  constexpr Coords out_tr =
      PanelLayoutRemap::remap({127, 0}, PanelLayout::TOP_LEFT_DOWN_ZIGZAG, panel_w, panel_h, rows, cols);
  // {0,63} row=1: x=0+0=0, y=31
  constexpr Coords out_bl =
      PanelLayoutRemap::remap({0, 63}, PanelLayout::TOP_LEFT_DOWN_ZIGZAG, panel_w, panel_h, rows, cols);
  // {127,63} row=1: x=0+127=127, y=31
  constexpr Coords out_br =
      PanelLayoutRemap::remap({127, 63}, PanelLayout::TOP_LEFT_DOWN_ZIGZAG, panel_w, panel_h, rows, cols);
...
consteval bool test_top_right_down_zigzag_2x2() {
  ...
  constexpr Coords out_tl =
      PanelLayoutRemap::remap({0, 0}, PanelLayout::TOP_RIGHT_DOWN_ZIGZAG, panel_w, panel_h, rows, cols);
  constexpr Coords out_tr =
      PanelLayoutRemap::remap({127, 0}, PanelLayout::TOP_RIGHT_DOWN_ZIGZAG, panel_w, panel_h, rows, cols);
  constexpr Coords out_bl =
      PanelLayoutRemap::remap({0, 63}, PanelLayout::TOP_RIGHT_DOWN_ZIGZAG, panel_w, panel_h, rows, cols);
  constexpr Coords out_br =
      PanelLayoutRemap::remap({127, 63}, PanelLayout::TOP_RIGHT_DOWN_ZIGZAG, panel_w, panel_h, rows, cols);
...
consteval bool test_bottom_left_up_zigzag_2x2() {
  ...
  constexpr Coords out_tl =
      PanelLayoutRemap::remap({0, 0}, PanelLayout::BOTTOM_LEFT_UP_ZIGZAG, panel_w, panel_h, rows, cols);
  // {127,0} row=0, inv_row=1: x=0+127=127, y=0
  constexpr Coords out_tr =
      PanelLayoutRemap::remap({127, 0}, PanelLayout::BOTTOM_LEFT_UP_ZIGZAG, panel_w, panel_h, rows, cols);
  // {0,63} row=1, inv_row=0: x=128+0=128, y=31
  constexpr Coords out_bl =
      PanelLayoutRemap::remap({0, 63}, PanelLayout::BOTTOM_LEFT_UP_ZIGZAG, panel_w, panel_h, rows, cols);
  // {127,63} row=1, inv_row=0: x=128+127=255, y=31
  constexpr Coords out_br =
      PanelLayoutRemap::remap({127, 63}, PanelLayout::BOTTOM_LEFT_UP_ZIGZAG, panel_w, panel_h, rows, cols);
...
consteval bool test_bottom_right_up_zigzag_2x2() {
  ...
  constexpr Coords out_tl =
      PanelLayoutRemap::remap({0, 0}, PanelLayout::BOTTOM_RIGHT_UP_ZIGZAG, panel_w, panel_h, rows, cols);
  constexpr Coords out_tr =
      PanelLayoutRemap::remap({127, 0}, PanelLayout::BOTTOM_RIGHT_UP_ZIGZAG, panel_w, panel_h, rows, cols);
  constexpr Coords out_bl =
      PanelLayoutRemap::remap({0, 63}, PanelLayout::BOTTOM_RIGHT_UP_ZIGZAG, panel_w, panel_h, rows, cols);
  constexpr Coords out_br =
      PanelLayoutRemap::remap({127, 63}, PanelLayout::BOTTOM_RIGHT_UP_ZIGZAG, panel_w, panel_h, rows, cols);
...
consteval bool test_bottom_right_up_vertical_2x1() {
  ...
  constexpr Coords top_left =
      PanelLayoutRemap::remap({0, 0}, PanelLayout::BOTTOM_RIGHT_UP, panel_w, panel_h, rows, cols);
  constexpr Coords top_right =
      PanelLayoutRemap::remap({63, 0}, PanelLayout::BOTTOM_RIGHT_UP, panel_w, panel_h, rows, cols);
  constexpr Coords bottom_left =
      PanelLayoutRemap::remap({0, 127}, PanelLayout::BOTTOM_RIGHT_UP, panel_w, panel_h, rows, cols);
  constexpr Coords bottom_right =
      PanelLayoutRemap::remap({63, 127}, PanelLayout::BOTTOM_RIGHT_UP, panel_w, panel_h, rows, cols);
...
consteval bool test_top_left_down_vertical_2x1() {
  ...
  constexpr Coords tl = PanelLayoutRemap::remap({0, 0}, PanelLayout::TOP_LEFT_DOWN, panel_w, panel_h, rows, cols);
  constexpr Coords tr = PanelLayoutRemap::remap({63, 0}, PanelLayout::TOP_LEFT_DOWN, panel_w, panel_h, rows, cols);
  constexpr Coords bl = PanelLayoutRemap::remap({0, 127}, PanelLayout::TOP_LEFT_DOWN, panel_w, panel_h, rows, cols);
  constexpr Coords br = PanelLayoutRemap::remap({63, 127}, PanelLayout::TOP_LEFT_DOWN, panel_w, panel_h, rows, cols);
...
consteval bool test_top_right_down_vertical_2x1() {
  ...
  constexpr Coords tl = PanelLayoutRemap::remap({0, 0}, PanelLayout::TOP_RIGHT_DOWN, panel_w, panel_h, rows, cols);
  constexpr Coords tr = PanelLayoutRemap::remap({63, 0}, PanelLayout::TOP_RIGHT_DOWN, panel_w, panel_h, rows, cols);
  constexpr Coords bl = PanelLayoutRemap::remap({0, 127}, PanelLayout::TOP_RIGHT_DOWN, panel_w, panel_h, rows, cols);
  constexpr Coords br = PanelLayoutRemap::remap({63, 127}, PanelLayout::TOP_RIGHT_DOWN, panel_w, panel_h, rows, cols);
...
consteval bool test_bottom_left_up_vertical_2x1() {
  ...
  constexpr Coords tl = PanelLayoutRemap::remap({0, 0}, PanelLayout::BOTTOM_LEFT_UP, panel_w, panel_h, rows, cols);
  constexpr Coords tr = PanelLayoutRemap::remap({63, 0}, PanelLayout::BOTTOM_LEFT_UP, panel_w, panel_h, rows, cols);
  constexpr Coords bl = PanelLayoutRemap::remap({0, 127}, PanelLayout::BOTTOM_LEFT_UP, panel_w, panel_h, rows, cols);
  constexpr Coords br = PanelLayoutRemap::remap({63, 127}, PanelLayout::BOTTOM_LEFT_UP, panel_w, panel_h, rows, cols);
